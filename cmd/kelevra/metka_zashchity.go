...
//
// САМОГО СЛОВА «защита» в этих строках больше нет (31.08). хозяин спрашивал про
// него трижды и каждый раз одно и то же — 22.08 «почему она ваще *** защита
// называется непонятно», 23.08 «ПОЧЕМУ *** ВСЕ ЕЩЕ КАКАЯ ТО *** ЗАЩИТА?».
// На телефоне, который он держит за эталон, этого слова нет НИГДЕ на экране
