...
// свежий (они читают znachok.ico напрямую). Жалоб на это было две: 23.08 —
// значок приложения на панели задач не сделан; 30.08 — значок должен быть
// круглым, а не квадратом.
//
