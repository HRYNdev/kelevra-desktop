...
// старой перед тем, как всё равно занять её место. Гонка 25.08 («2 ***
...
func main() {
	...
	// Свежесть больше не подменяет .exe САМА на холодном старте (заказ хозяина
...
//
//	25.08 (7f31c1c): жалоба «2 *** открыто» — при смене режима на секунды
