...
// #111310) висит белая системная полоса сверху (правка 30.08: заголовок
// красится под цвет приложения, а не остаётся белым). DWM красит заголовок
// целиком — собственный цвет ему не передать, тёмный/светлый режим это максимум,
...
func vklyuchitTemnyyZagolovok(hwnd syscall.Handle) {
	...
	// белую полосу сверху (беда 30.08). SWP_FRAMECHANGED заставляет
