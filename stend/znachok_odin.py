...
Зачем. 01.09, после установки 0.6.44, пришла жалоба: значок на панели задач,
в трее и сверху у приложения искривлён, на экране он как минимум дублируется,
причём два значка разные, и круг у значка стал неоправданно жирным.
Смотрели на один и тот же .ico — но кадры внутри него были нарисованы
