#!/usr/bin/env python3
"""Живой стенд второй двери кнопки #knopka-obnovlenie (index.html, 28.08):
когда фон нашёл версию новее, та же кнопка не «проверяет», а СТАВИТ её через
/api/obnovlenie_postavit — ровно ту ручку, что уже дёргает тычок в пузырь
трея. stend/oblik_snimok.py доказывает окно против ПОДСТАВНОЙ /api/*
