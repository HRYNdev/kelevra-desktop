...
SCENY = {
    ...
    # адаптера осталось занято остатком прошлого подключения (замер с машины
    # хозяина 01.09: «create adapter: файл уже существует | open existing
...
# глаз человека. хозяин, дословно: «какого хера приложение теперь опять надо
# прокручивать, нельзя масштаб нормально сделать на главной странице».
#
# Что случилось. Строку подписки («Ключ доступа: хозяин · действует до 12
...
def kontrol_prokrutki(br, port):
    ...
    484px до 555px при окне 504px — то же переполнение, что хозяин видел на
