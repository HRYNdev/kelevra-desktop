...
# 27.08→28.08: секция «Сеть» несла единственный пункт — тумблер авторежима,
# 27.08 он переехал на главный экран полосой выбора режима (Вова: «управление
# режимом должно быть в одном месте, а не в двух»), а 28.08 вернулся обратно
# на вкладку «Настройки» той же полосой (Вова, впервые открыв программу:
# «настройки из отдельной вкладки нахуя то переехали вниз основной, это ваще
# не удобно») — секция «Сеть» снова первым блоком, теперь под полосой, а не
# под тумблером.
