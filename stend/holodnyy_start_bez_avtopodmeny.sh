...
#
# Заказ 26.08 11:33: обновления приходят сами, ставит их человек нажатием, а
# не автомат, и нужна кнопка «Проверить обновление».
# Диагноз: main.go на КАЖДОМ холодном старте звал obnovitsya()
