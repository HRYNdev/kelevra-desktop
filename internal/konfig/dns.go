...
// (прокси за резолв не отвечает), и в базе ядра на машине хозяина не нашлось ни
...
// домен ЭТИМ сервером. В журнале ядра у хозяина этот резолвер умирает:
...
// включая домашний роутер хозяина, который сам делает обход, гостевые сети с
