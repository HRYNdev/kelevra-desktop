...
const (
	...
	ZametkaBezPrav = "Через Kelevra идут только браузеры. Игры и видео Windows " +
		"направляет мимо. Чтобы через Kelevra шло всё, нажмите кнопку ниже."
	...
	ZametkaBezTunnelya = "Через Kelevra идут только браузеры. Игры и видео идут " +
		"напрямую: полный режим не предусмотрен вашим кодом доступа."
	...
	ZametkaRuchnoyProksi = "Windows не применил параметры прокси автоматически. " +
		"Откройте Параметры → Сеть и Интернет → Прокси и укажите адрес %s"
	...
	ZametkaTunnelNePodnyalsya = "Через Kelevra идут только браузеры. Игры и видео " +
		"идут напрямую: полный режим сейчас не поднялся."
	...
	ZametkaAdapterZanyat = "Через Kelevra идут только браузеры. Игры и видео идут " +
		"напрямую: сетевое устройство Windows удерживается прошлым подключением. " +
		"Устройство освобождается перезагрузкой компьютера."
	...
	ZametkaBezSetevyhPravil = "Список правил не загружен, разбор трафика отключён."
	...
	ZametkaPravilaIzKomplekta = "Актуальные правила не загружены, применяются встроенные от %s."
)
