...
const (
	...
	// убрано (Вова, 24.08: «слово "защита" второй раз режет») — круг над
	...
	ZametkaBezPrav = "Чтобы защитить весь компьютер, нажмите ниже."
	...
	// раз это же слово только путало (Вова, 24.08: «слово "защита" второй
