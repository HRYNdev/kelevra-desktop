...
// Жалоба 28.08: при нажатии кнопки «Подключиться» программа не определяла,
// дома человек или нет, а при выключенной защите определяла лишь иногда.
// Замер следователя (синтетический стенд, 3/3
