...
// (`selector`): в боевом профиле это «Соединение» с вариантами «Нидерланды»
// и «Комната».
...
func (y *Yadro) Gruppy() ([]Gruppa, error) {
	...
	for imya, u := range v.Proxies {
		...
		// предрешён. В окне она была лишней строкой (проверено на боевом профиле:
...
// состоянии показывало пустой список — снимок 21.08, «300px пустого
