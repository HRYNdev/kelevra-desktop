...
type otvetSostoyaniya struct {
	...
	// включить» на то, что человек уже нажал (Вова, 27.08).
...
// ручкой /api/avtorezhim, и кнопкой «Подключиться» (podklyuchit) — Вова
// (27.08): «я включаю впн включаю сука его, тыкаю на него и тогда он
// определяет... и так же когда я вернусь домой он тоже сука вернётся в
...
func (s *Sluzhba) podklyuchit(w http.ResponseWriter, r *http.Request) {
	...
	// Вова, 28.08: «когда программа определила что я дома, она не даёт
