...
// Заказ хозяина (28.08, первая беда): «нажимаю подключиться, он *** не
...
// хозяина (28.08): «когда программа определила что я дома, она не даёт
...
//
// Правка 31.08 (схема «одна кнопка», хозяин 27.08: «жму подключить → сам
// определяет») сдвинула ровно одну вещь: ручной режим теперь опознаётся не
// по выключенному тумблеру, а по ЯВНОМУ отказу человека. Выключенный
