...
// Схема «одна кнопка», которую просил хозяин (27.08): «жму подключить → сам
// определяет → дома "режим ожидания", вне дома включается». Здесь проверяется
...
// (shema_vovy_test.go), на подставных зондах и без единого сетевого запроса.
...
// и это сказано словами, а не угадывается по цвету круга (хозяин, 27.08).
...
// TestVyhodDlyaOkna — хозяин, 27.08: «ты туда натыкал Нидерланды прямой,
// запасной, комната и тд, должно быть тупо выбор авто режим». Пока человек в
